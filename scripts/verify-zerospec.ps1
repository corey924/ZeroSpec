...
Assert-FileExists '.github/ISSUE_TEMPLATE/docs-or-wording.md'
Assert-FileExists '.github/ISSUE_TEMPLATE/feature-request.md'
Assert-FileExists 'CODE_OF_CONDUCT.md'
Assert-FileExists 'CODE_OF_CONDUCT.zh-TW.md'
Assert-FileExists 'SECURITY.md'
Assert-FileExists 'SECURITY.zh-TW.md'
Assert-FileExists 'SUPPORT.md'
